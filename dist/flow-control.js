...
export const TRANSFER_UPGRADE_REQUIRED = "connector exec/cp requires byte-credit-v1 flow control; upgrade the public nuum-connector daemon and Persona connector provider/client";
